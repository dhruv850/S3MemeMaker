      ...
      <div>
        <div className="main-content">
          <div className="sidebar">
            <NavbarBrand href="/">MultiMemeMaker</NavbarBrand>
            <p>
              Inspired by Other Websites and Meme Templates. Built with React.
            </p>
            <p>
           You can change position of the text.
        
           Created Just to Learn and Spread Laugh, Happy Meme Making.
            </p>
          </div>
          <div className="content">
            {photos.map((image, index) => (
              <div className="image-holder" key={image.src}>
                <span className="meme-top-caption">Add text</span>
                <img
                  style={{
                    width: "100%",
                    cursor: "pointer",
                  ...
                  role="presentation"
                />
              <span className="meme-bottom-caption">Add text</span>
              </div>
            ))}
          </div>
        </div>
